!function () {
  ...
  var EnemyShip = Asteroids.EnemyShip = function (options) {
    ...
    this.fire = setInterval(this.fireBullet.bind(this), 2000);
  };
  ...
  EnemyShip.prototype.fireBullet = function () {
    var direction = Math.atan2((this.ship.pos[0] - this.pos[0]), (this.ship.pos[1] - this.pos[1]))
    var newVel = [Math.sin(direction) * 5, Math.cos(direction) * 5];
